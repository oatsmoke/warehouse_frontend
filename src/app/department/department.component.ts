...
export class DepartmentComponent implements OnInit {
    ...
    deleteDepartment(id: number) {
        this.dialog.open(DialogDepartmentDelete).afterClosed().pipe(first()).subscribe(value => {
            if (value) {
...
@Component({
    selector: 'dialog-department-delete', templateUrl: './dialog-department-delete.html'
})
export class DialogDepartmentDelete {
}